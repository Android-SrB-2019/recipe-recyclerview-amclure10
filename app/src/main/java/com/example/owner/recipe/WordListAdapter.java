...
public class WordListAdapter extends
    ...
    class WordViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            Recipe recipe = recipes.get(mPosition);
            // Change the word in the mWordList.


            //recipes.set(mPosition, "Clicked! " + recipe.name);
    ...
    public WordListAdapter(Context context, LinkedList<Recipe> wordList) {
        mInflater = LayoutInflater.from(context);
        this.recipes = wordList;
    }
    ...
    public void onBindViewHolder(WordListAdapter.WordViewHolder holder,
        ...
        holder.wordItemView.setText(recipe.name);
    }
